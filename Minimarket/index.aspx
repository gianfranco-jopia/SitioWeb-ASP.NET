<%@ Page Title="" Language="C#" MasterPageFile="~/menuP.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Minimarket.homeP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <body>
        ...
        <table class="auto-style1" style="text-align:center;">
            <tr>
                <td>
                    <asp:ImageButton ID="ImageButton1" runat="server" Height="210px" Width="210px" ImageUrl="~/img/pan.jpg" PostBackUrl="~/Login.aspx" />
                </td>
                <td>
                    <asp:ImageButton ID="ImageButton2" runat="server" Height="210px" Width="210px" ImageUrl="~/img/carnes.jpg" PostBackUrl="~/Login.aspx" />
                </td>
                <td>
                    <asp:ImageButton ID="ImageButton3" runat="server" Height="210px" Width="210px" ImageUrl="~/img/despensa.png" PostBackUrl="~/Login.aspx" />
                </td>
            </tr>
            <tr>
                <td>Panaderia</td>
            ...
            <tr>
                <td>&nbsp;</td>
                <td>
                    <asp:ImageButton ID="ImageButton4" runat="server" Height="210px" Width="210px" ImageUrl="~/img/botilleria.png" PostBackUrl="~/Login.aspx" />
                </td>
            </tr>
            <tr>
