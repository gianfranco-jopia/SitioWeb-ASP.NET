<%@ Page Title="" Language="C#" MasterPageFile="~/menu.Master" AutoEventWireup="true" CodeBehind="Producto.aspx.cs" Inherits="Minimarket.Producto" MaintainScrollPositionOnPostback="true"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section id="banner">
		...
		<div class="form">
    		...
    		<br>
     		<div>
         		<asp:TextBox ID="TxtCodigo" runat="server" placeholder="Buscar por nombre" BorderColor="#FF6600" BorderStyle="Solid" BorderWidth="1px"  Width="410px" ></asp:TextBox>
                <br />
